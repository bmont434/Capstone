/*Converation js file: IBM template: Used for simple watson conversation payload column.*/
...
var PayloadPanel = (function() {
  var settings = {
    selectors: {
      payloadColumn: '#chat-column',   //renamed to 'chat-column' from 'payload-column'
